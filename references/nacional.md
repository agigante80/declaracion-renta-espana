...
Documento de referencia con la normativa estatal del Impuesto sobre la Renta de las Personas Físicas (IRPF) para el ejercicio 2025. Toda la información procede de fuentes oficiales: AEAT (Agencia Estatal de Administración Tributaria) y BOE.
...
**Rentas inmobiliarias imputadas, rendimientos de Letras del Tesoro y subvenciones para vivienda protegida:**
- Hasta 1.000 euros anuales conjuntamente

**Importante:** Estan obligados a declarar en todo caso los beneficiarios del Ingreso Minimo Vital (IMV).

### Situaciones que obligan siempre a declarar
- Derecho a aplicar deducciones por inversion en vivienda, cuenta ahorro-empresa, doble imposicion internacional, o deducciones por aportaciones a patrimonios protegidos o planes de pensiones
...
Aplicable al 50% de la base liquidable general (el otro 50% tributa por la escala autonomica).
...
**Tipo marginal maximo estatal:** 24,50% (a partir de 300.000 euros)

**Nota:** El tipo efectivo total (estatal + autonomico) oscila entre el 19% y el 47%-54% segun la comunidad autonoma.
...
El mínimo personal y familiar es la parte de la base liquidable que, por destinarse a satisfacer las necesidades basicas personales y familiares del contribuyente, no se somete a tributacion. Se resta de la base para calcular la cuota.

### 4.1. Minimo del contribuyente

| Concepto | Cuantia anual (euros) |
|---|---|
| Con caracter general | 5.550 |
...
- Convivencia con el contribuyente (al menos la mitad del periodo, excepto en custodia compartida)
- No haber obtenido rentas superiores a 8.000 euros anuales (excluidas las exentas)
- No haber presentado declaracion con rentas superiores a 1.800 euros

| Descendiente | Cuantia anual (euros) |
|---|---|
| Primero | 2.400 |
| Segundo | 2.700 |
| Tercero | 4.000 |
...
Se aplica tanto al contribuyente como a ascendientes y descendientes que generen derecho a minimo.
...
| Concepto | Cuantia maxima anual |
|---|---|
| Otros gastos (cuantia general) | 2.000 euros |
| Incremento por movilidad geografica (desempleado que acepta empleo en otro municipio) | +2.000 euros |
...
### 5.2. Reducción por obtención de rendimientos del trabajo (Articulo 18 LIRPF)
...
|---|---|
| RNT <= 14.852,00 euros | 7.302 euros (reducción máxima) |
...
### 5.3. Reducción por rendimientos del trabajo artistico (Novedad 2025)

Desde el 1 de enero de 2025 (Disposicion adicional sexagesima LIRPF), se aplica una reducción del 30% a los rendimientos del trabajo derivados de la elaboracion de obras literarias, artisticas o cientificas, incluida la actividad artistica audiovisual y musical, cuando:

- No esten sujetos a otra reduccion del articulo 18 LIRPF
- El rendimiento integro de estas actividades supere el 130% de la media de los rendimientos de los 3 periodos impositivos anteriores
- La reduccion se aplica sobre la diferencia entre el rendimiento integro y la media de los 3 ejercicios anteriores
- Limite maximo: 150.000 euros anuales de rendimiento integro sujeto a reduccion

### 5.4. Rentas exentas del trabajo (principales)

- **Indemnizaciones por despido o cese:** Exentas hasta la cuantía legalmente establecida en el Estatuto de los Trabajadores (como máximo 180.000 euros, equivalente a 45 dias de salario por ano de antigüedad)
- **Indemnización por resolución contrato abuelo:** Exenta conforme a normas laborales
- **Prestaciones públicas por actos de terrorismo:** 100% exentas
- **Prestaciones por incapacidad permanente absoluta o gran invalidez:** 100% exentas
- **Becas públicas y de entidades sin ánimo de lucro:** Exentas si cubren gastos de formacion o educacion
...
- **Prestaciones por proteccion de víctimas de violencia de genero:** Exentas
...
7. Aplicar reducción por rendimientos del trabajo (§5.2)
...
- Gastos de conservacion, reparación y mantenimiento del inmueble
...
- Amortización: 3% anual sobre el mayor entre coste de adquisición y valor catastral (EXCLUIDO el suelo, que no se amortiza)
...
**Límite especial:** Los gastos de intereses + conservacion no pueden exceder el 100% de los rendimientos integros brutos (sin deduccion de otros gastos). El exceso se puede compensar en los 4 ejercicios siguientes.

### 6.2. Reducciones por arrendamiento de vivienda

**Novedad 2025 (contratos firmados desde 26/05/2023):**
- Reducción del 90%: si el propietario reduce el alquiler un 5% respecto al contrato anterior en zonas de mercado de vivienda tensionado (declaradas por CCAA)
- Reducción del 70%: arrendamiento por primera vez en zonas de mercado de vivienda tensionado a jovenes (18-35 años), o vivienda de proteccion oficial/precio limitado
- Reducción del 60%: vivienda rehabilitada en los 2 años anteriores conforme a normativa de eficiencia energetica
...
Inmuebles urbaños no afectos a actividades económicas, excluida la vivienda habitual:
...
- Comisiones de gestión de fondos de inversion (no se deducen del rendimiento)
...
Las actividades económicas (autónomos y profesionales) pueden tributar bajo tres sistemas principales:

**8.1. Estimación directa:** Se declara el resultado real (ingresos - gastos deducibles). Puede ser normal (> 600.000 EUR cifra negocios) o simplificada (< 600.000 EUR), con máximo 2.000 EUR por gastos de difícil justificación (7% rendimiento neto).

**8.2. Estimación objetiva (módulos):** Sistema simplificado aplicable a ciertas actividades de servicios, comercio y hostelería. Rendimiento calculado por aplicación de índices estatales/autonómicos. Requiere < 250.000 EUR ingresos y compras, no acogimiento a módulos en 3 años anteriores.

**8.3. Reducción por inicio:** El 20% del rendimiento neto positivo en los dos primeros años de actividad económica para contribuyentes que inician por primera vez.

**Modelos de declaración:**
- Estimación directa: modelo 130 (anual) o 131 (trimestral pagos fraccionados)
- Retenciones sobre facturas: dependen de actividad y cliente
- Margen neto reducible: 7% si no se justifican todos los gastos (máx. 2.000 EUR/año)
...
### 9.1. Regla general de calculo

Ganancia/Perdida = Valor de transmision - Valor de adquisicion

- Valor de transmision: importe real de la enajenacion menos gastos y tributos inherentes
- Valor de adquisicion: importe real de la adquisicion mas inversiones y mejoras, mas gastos y tributos inherentes, menos amortizaciones

### 9.2. Integracion en la base imponible

**Base imponible del ahorro:**
- Transmision de elementos patrimoniales (inmuebles, acciones, fondos de inversion, criptomonedas...)
...
1. Pérdidas patrimoniales se compensan PRIMERO con ganancias patrimoniales de la misma base (sin limite)
...
- Perdidas no compensadas en el ejercicio se arrastran a los 4 ejercicios siguientes (máximo 4 años)
- Plazo de prescripcion para arrastrar: 4 años naturales desde el cierre del ejercicio en que se generó la perdida

**Pérdidas patrimoniales de la base general:**
...
**Exención de transmisión de vivienda habitual:**
- Transmisión de vivienda habitual por mayores de 65 años: ganancia EXENTA (sin limites)
- Requisitos: Vivienda debe haber sido habitual durante minimo 3 años en los 5 años anteriores a la transmision

**Reinversión en vivienda habitual:**
- Ganancia exenta (sin limite) si se reinvierte en otra vivienda habitual dentro de 2 años (12 meses antes o 24 meses despues de venta)
- La nueva vivienda debe ser habitual durante minimo 3 años
...
- Requisitos: empresa creada hace <= 2 años, inversión realizada por contribuyente
...
| Concepto | Limite maximo anual |
|---|---|
| Aportacion individual (plan de pensiones, PPA, mutualidades...) | 1.500 euros |
...
- Limitacion sobre rendimientos: no puede superarse el 30% de los rendimientos netos del trabajo + actividades económicas del aportante, o 10.000 euros si esta cantidad es superior
...
|---|---|---|---|
| Adquisicion vehículo eléctrico enchufable (PHEV) | 15% | 20.000 euros (300 euros maximo) | Matriculado en España, potencia <= 300 kW |
| Adquisición vehículo de pila de combustible (hidrogeno) | 15% | 20.000 euros (300 euros maximo) | Matriculado en España |
...
### 12.2. Reducción por tributación conjunta (articulo 20 LIRPF)
...
- Gasto difícil justificación: 7% × (40.000 - 8.000) = 2.240 EUR
...
1. **Rendimiento neto de actividad económica:**
   ...
   - Gastos difícil justificación (máx. 2.000): 2.000 EUR
   - Rendimiento neto: 40.000 - 8.000 - 2.000 = 30.000 EUR

2. **Reduccion por inicio actividad (Novedad 2025):**
   - ¿Es el primer año?: NO (asumimos año 5 de actividad)
   - Reducción aplicable: 0 EUR

3. **Rendimiento neto reducido: 30.000 EUR**

4. **Base liquidable general:**
   - Rendimiento actividad: 30.000 EUR
   - Cotizaciones SS (RETA): 3.600 EUR (deducible)
   - Mínimo personal cónyuge (biparental): 3.400 EUR
   - Mínimo del contribuyente: 5.550 EUR
   - Base liquidable: 30.000 - 3.600 - 3.400 - 5.550 = 17.450 EUR

5. **Cuota íntegra estatal (50%):**
   - Hasta 12.450 EUR × 9,50% = 1.182,75 EUR
   - Siguiente 5.000 EUR × 12% = 600 EUR
   - Cuota integra: 1.782,75 EUR
   - Cuota estatal (50%): 891,38 EUR

6. **Cuota íntegra autonómica (Catalunya, 50%):**
   - Mismos tramos: 891,38 EUR

7. **Cuota líquida total:**
   - 891,38 + 891,38 = 1.782,76 EUR

8. **Cuota diferencial:**
   - Cuota líquida: 1.782,76 EUR
   - Retenciones por facturas: 6.000 EUR
   - Pagos fraccionados 130 (asumiendo 0 en este año): 0 EUR
   - Total retenciones/pagos: 6.000 EUR
   - Diferencial: 1.782,76 - 6.000 = -4.217,24 EUR
   
   **Resultado: A DEVOLVER 4.217,24 EUR**

**Nota sobre pagos fraccionados:** Si hubiera realizado pagos fraccionados (modelo 130) por ejemplo 300 EUR/trimestre = 1.200 EUR/año, la cuota diferencial sería: 1.782,76 - 6.000 - 1.200 = -5.417,24 EUR (mayor devolución).
